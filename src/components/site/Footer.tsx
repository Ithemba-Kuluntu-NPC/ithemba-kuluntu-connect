    ...
    <footer className="mt-24 border-t border-border bg-[var(--ithemba-blue-dark)] text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        ...
        <div className="text-sm text-white/85">
          ...
          <ul className="mt-2 space-y-1.5">
            ...
            <li className="flex items-start gap-2 pt-1.5">
              ...
              <span>
                Flat Rock Cottage, Cwebeni Beach, Port St Johns, Eastern Cape, South Africa, 5090
              </span>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-3.5 w-3.5 shrink-0" />
              <a href="mailto:info@ithembakuluntu.org" className="hover:text-white">
                info@ithembakuluntu.org
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-3.5 w-3.5 shrink-0" />
              <a href="tel:+27719778063" className="hover:text-white">
                +27 71 977 8063
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <form onSubmit={form.submit} className="mt-3 space-y-2">
            <Input
              type="email"
              required
              maxLength={254}
            ...
            <Button
              ...
              type="submit"
              className="w-full rounded-full bg-[var(--ithemba-yellow)] text-[var(--ithemba-brown)] hover:bg-[var(--ithemba-yellow)]/90 font-semibold"
            >
              {form.status === "submitting"
                ? lbl("Sending…", "Wird gesendet…", "Wordt verzonden…")
                : lbl("Subscribe", "Abonnieren", "Abonneren")}
            </Button>
            <p aria-live="polite" className="min-h-4 text-xs text-white/80">
              {message}
            </p>
          </form>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-3 px-4 py-5 pb-24 text-xs text-white/70 md:flex-row md:items-center md:justify-between md:pb-5 lg:px-8">
          ...
          <nav className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            <Link to="/donation-terms" className="hover:text-white">
              Donation Terms
            </Link>
          </nav>
        </div>
