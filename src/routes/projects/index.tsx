...
function ProjectsOverview() {
  ...
  return (
    <>
      ...
      <section id="projects-overview-grid" className="mx-auto max-w-7xl px-4 pb-10 md:pb-12 lg:px-8">
      ...
      <style>{`main:has(#projects-overview-grid) + footer { margin-top: 0; }`}</style>
    </>
  );
}
